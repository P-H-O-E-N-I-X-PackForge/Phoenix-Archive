...
public class PhoenixNetwork {
    ...
    public static void init() {
        ...
        CHANNEL.registerMessage(0, SyncLorePacket.class, SyncLorePacket::encode, SyncLorePacket::decode, SyncLorePacket::handle);

        // ID 1: Bulk synchronization (used for dimension hops, login, and respawn)
        CHANNEL.registerMessage(1, BulkSyncLorePacket.class, BulkSyncLorePacket::encode, BulkSyncLorePacket::decode, BulkSyncLorePacket::handle);
    }
}